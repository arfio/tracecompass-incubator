...
public class EventdevPortsBusynessDataProvider
     ...
     * {@link PipelinePortsBusynessDataProvider}.
     */
    ...
    private static final class PipelinePortsBuilder {
        ...
        private void updateValue(int pos, long zeroPolls, long totPolls, long deltaT) {
            ...
            // if((zeroPolls != fPrevCountZeroPolls) || (nonZeroPolls !=
            // fPrevCountNonZeroPolls)) {
    ...
    /**
     * Create an instance of {@link PipelinePortsBusynessDataProvider}. Returns
     * a null instance if the analysis module is not found.
     *
     * @param trace
     *            A trace on which we are interested to fetch a model
     * @return A {@link PipelinePortsBusynessDataProvider} instance. If analysis
     ...
     * @return List<PipelinePortsBuilder>
     */
