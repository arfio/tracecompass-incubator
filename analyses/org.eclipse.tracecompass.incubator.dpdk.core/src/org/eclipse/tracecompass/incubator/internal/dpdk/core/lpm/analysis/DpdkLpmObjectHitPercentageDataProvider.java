...
/**
 * LPM Hit/Miss Ratio DataProvider. This data provider will return a XY model
 * (model is wrapped in a response) based on a query filter. The model is used
 * afterwards by any viewer to draw charts.
 *
...
public class DpdkLpmObjectHitPercentageDataProvider extends AbstractTreeCommonXDataProvider<@NonNull DpdkLpmObjectLookupAnalysisModule, @NonNull TmfTreeDataModel> {
     ...
     * {@link DpdkLpmObjectHitPercentageDataProvider}.
     */
    ...
    /**
     * Create an instance of {@link DpdkLpmObjectHitPercentageDataProvider}.
     * Returns a null instance if the analysis module is not found.
     *
     * @param trace
     *            A trace on which we are interested to fetch a model
     * @return A {@link DpdkLpmObjectHitPercentageDataProvider} instance. If
    ...
    // @Override
    // @Deprecated
    // protected Map<@NonNull String, @NonNull IYModel>
    // getYModels(ITmfStateSystem ss, Map<String, Object> fetchParameters,
