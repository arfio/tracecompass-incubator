...
public class InterPipelinesPacketRateDataProvider
     ...
     * {@link InterPipelinesPacketRateDataProvider}.
     */
    ...
    /**
     * Create an instance of {@link InterPipelinesPacketRateDataProvider}.
     * Returns a null instance if the analysis module is not found.
     *
     * @param trace
     *            A trace on which we are interested to fetch a model
     * @return A {@link InterPipelinesPacketRateDataProvider} instance. If
    ...
    protected TmfTreeModel<@NonNull TmfTreeDataModel> getTree(ITmfStateSystem ss, Map<String, Object> parameters,
        ...
        for (Integer sourcePipelineQuark : fMapPipelineOutputPorts.keySet()) {
            ...
            for (Integer targetPipelineQuark : fMapPipelineInputPorts.keySet()) {
                ...
                /*
                 * Compute the intersection of the two lists : output ports and
                 * input ports
                 */
