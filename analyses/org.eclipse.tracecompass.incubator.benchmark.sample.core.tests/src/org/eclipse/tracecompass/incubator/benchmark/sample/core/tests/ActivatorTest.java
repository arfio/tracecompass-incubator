/*******************************************************************************
 * Copyright (c) 2021 Polytechnique Montreal
 *
...
package org.eclipse.tracecompass.incubator.benchmark.sample.core.tests;
...
public class ActivatorTest extends Plugin {
     ...
     * The plug-in ID
     */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.benchmark.sample.core.tests"; //$NON-NLS-1$
    ...
    public void testActivator() {
        ...
        assertEquals("org.eclipse.tracecompass.incubator.benchmark.sample.core", instance.getPluginId());
    }
